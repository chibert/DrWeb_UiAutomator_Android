...
//должен заблочится по категории Социальные сети
        ...
        */
        ...
        mDevice.findObject(By.text("Cloud Checker")).click();
        mDevice.waitForWindowUpdate(drWebPkg, 1000);
        BrowsersUtils2.onCloudCheker(true);
        mDevice.waitForWindowUpdate(drWebPkg, 1000);
        BrowsersUtils2.setCategoryInCloudCheker("Нерекомендуемые сайты", false);
        BrowsersUtils2.setCategoryInCloudCheker("Сайты для взрослых", false);
        BrowsersUtils2.setCategoryInCloudCheker("Насилие", false);
        BrowsersUtils2.setCategoryInCloudCheker("Оружие", false);
        BrowsersUtils2.setCategoryInCloudCheker("Азартные игры", false);
        BrowsersUtils2.setCategoryInCloudCheker("Наркотики", false);
        BrowsersUtils2.setCategoryInCloudCheker("Нецензурная лексика", false);
        BrowsersUtils2.setCategoryInCloudCheker("Чаты", false);
        BrowsersUtils2.setCategoryInCloudCheker("Терроризм", false);
        BrowsersUtils2.setCategoryInCloudCheker("Электронная почта", false);
        BrowsersUtils2.setCategoryInCloudCheker("Социальные сети", false);
        BrowsersUtils2.setCategoryInCloudCheker("URL, добавленные по обращению правообладателя", false);

        Utils.startMainActivityFromHomeScreen(browserPKG);

        BrowsersUtils2.openURL(browserPKG, "http://justclick.ru", false);
        BrowsersUtils2.openURL(browserPKG, "http://xvideos.com", false);
        BrowsersUtils2.openURL(browserPKG, "http://twin-towers.net", false);
        BrowsersUtils2.openURL(browserPKG, "http://guns.com", false);
        BrowsersUtils2.openURL(browserPKG, "http://altaigames.com", false);
        BrowsersUtils2.openURL(browserPKG, "http://tweaker.org", false);
        BrowsersUtils2.openURL(browserPKG, "http://udaff.com", false);
        BrowsersUtils2.openURL(browserPKG, "http://chat.ru", false);
        BrowsersUtils2.openURL(browserPKG, "http://www.deadhouse.ru/gallery/terrorism/", false);
        BrowsersUtils2.openURL(browserPKG, "http://e-mail.ru", false);
        BrowsersUtils2.openURL(browserPKG, "http://vk.com", false);
        BrowsersUtils2.openURL(browserPKG, "http://drweb-ru.com", false);
        //BrowsersUtils2.openURL(browserPKG, "", false);
        //BrowsersUtils2.openURL(browserPKG, "", false);
        //BrowsersUtils2.openURL(browserPKG, "", false);
        //BrowsersUtils2.openURL(browserPKG, "", false);

        BrowsersUtils2.openURL(browserPKG, "www.yt118.com", true);
        ...
        mDevice.findObject(By.text("Cloud Checker")).click();
        mDevice.waitForWindowUpdate(drWebPkg, 1000);
        BrowsersUtils2.setCategoryInCloudCheker("Нерекомендуемые сайты", true);

        Utils.startMainActivityFromHomeScreen(browserPKG);
        BrowsersUtils2.openURL(browserPKG, "http://justclick.ru", true);
        Thread.sleep(2000);
        ...
        Utils.startMainActivityFromHomeScreen(browserPKG);
        BrowsersUtils2.openURL(browserPKG, "http://xvideos.com", true);
        Thread.sleep(2000);
        ...
        mDevice.waitForWindowUpdate(drWebPkg, 1000);
        BrowsersUtils2.setCategoryInCloudCheker("Сайты для взрослых", false);
        BrowsersUtils2.setCategoryInCloudCheker("Насилие", true);

        Utils.startMainActivityFromHomeScreen(browserPKG);
        BrowsersUtils2.openURL(browserPKG, "http://twin-towers.net", true);
        Thread.sleep(2000);
        ...
        mDevice.waitForWindowUpdate(drWebPkg, 1000);
        BrowsersUtils2.setCategoryInCloudCheker("Насилие", false);
        BrowsersUtils2.setCategoryInCloudCheker("Оружие", true);

        Utils.startMainActivityFromHomeScreen(browserPKG);
        BrowsersUtils2.openURL(browserPKG, "http://guns.com", true);
        Thread.sleep(2000);
        ...
        mDevice.waitForWindowUpdate(drWebPkg, 1000);
        BrowsersUtils2.setCategoryInCloudCheker("Оружие", false);
        BrowsersUtils2.setCategoryInCloudCheker("Азартные игры", true);

        Utils.startMainActivityFromHomeScreen(browserPKG);
        BrowsersUtils2.openURL(browserPKG, "http://altaigames.com", true);
        Thread.sleep(2000);
        ...
        mDevice.waitForWindowUpdate(drWebPkg, 1000);
        BrowsersUtils2.setCategoryInCloudCheker("Азартные игры", false);
        BrowsersUtils2.setCategoryInCloudCheker("Наркотики", true);

        Utils.startMainActivityFromHomeScreen(browserPKG);
        BrowsersUtils2.openURL(browserPKG, "http://tweaker.org", true);
        Thread.sleep(2000);
        ...
        mDevice.waitForWindowUpdate(drWebPkg, 1000);
        BrowsersUtils2.setCategoryInCloudCheker("Наркотики", false);
        BrowsersUtils2.setCategoryInCloudCheker("Нецензурная лексика", true);

        Utils.startMainActivityFromHomeScreen(browserPKG);
        BrowsersUtils2.openURL(browserPKG, "http://udaff.com", true);
        Thread.sleep(2000);
        ...
        mDevice.waitForWindowUpdate(drWebPkg, 1000);
        BrowsersUtils2.setCategoryInCloudCheker("Нецензурная лексика", false);
        BrowsersUtils2.setCategoryInCloudCheker("Чаты", true);

        Utils.startMainActivityFromHomeScreen(browserPKG);
        BrowsersUtils2.openURL(browserPKG, "http://chat.ru", true);
        Thread.sleep(2000);
        ...
        mDevice.waitForWindowUpdate(drWebPkg, 1000);
        BrowsersUtils2.setCategoryInCloudCheker("Чаты", false);
        BrowsersUtils2.setCategoryInCloudCheker("Терроризм", true);

        Utils.startMainActivityFromHomeScreen(browserPKG);
        BrowsersUtils2.openURL(browserPKG, "http://www.deadhouse.ru/gallery/terrorism/", true);
        Thread.sleep(2000);
        ...
        mDevice.waitForWindowUpdate(drWebPkg, 1000);
        BrowsersUtils2.setCategoryInCloudCheker("Терроризм", false);
        BrowsersUtils2.setCategoryInCloudCheker("Электронная почта", true);

        Utils.startMainActivityFromHomeScreen(browserPKG);
        BrowsersUtils2.openURL(browserPKG, "http://e-mail.ru", true);
        Thread.sleep(2000);
        ...
        Utils.startMainActivityFromHomeScreen(browserPKG);
        BrowsersUtils2.openURL(browserPKG, "http://vk.com", true);
        Thread.sleep(2000);
        ...
        mDevice.waitForWindowUpdate(drWebPkg, 1000);
        BrowsersUtils2.setCategoryInCloudCheker("Социальные сети", false);
        BrowsersUtils2.setCategoryInCloudCheker("URL, добавленные по обращению правообладателя", true);

        Utils.startMainActivityFromHomeScreen(browserPKG);
        BrowsersUtils2.openURL(browserPKG, "http://drweb-ru.com", true);
        Thread.sleep(2000);
