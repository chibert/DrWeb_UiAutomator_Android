...
//должен заблочится по категории Социальные сети
        ...
        */
        ...
        //mDevice.waitForWindowUpdate(drWebPkg, 1000);
        BrowsersUtils4.setCategoryInCloudCheker("Нерекомендуемые сайты", false);
        BrowsersUtils4.setCategoryInCloudCheker("Сайты для взрослых", false);
        BrowsersUtils4.setCategoryInCloudCheker("Насилие", false);
        BrowsersUtils4.setCategoryInCloudCheker("Оружие", false);
        BrowsersUtils4.setCategoryInCloudCheker("Азартные игры", false);
        BrowsersUtils4.setCategoryInCloudCheker("Наркотики", false);
        BrowsersUtils4.setCategoryInCloudCheker("Нецензурная лексика", false);
        BrowsersUtils4.setCategoryInCloudCheker("Чаты", false);
        BrowsersUtils4.setCategoryInCloudCheker("Терроризм", false);
        BrowsersUtils4.setCategoryInCloudCheker("Электронная почта", false);
        BrowsersUtils4.setCategoryInCloudCheker("Социальные сети", false);
        BrowsersUtils4.setCategoryInCloudCheker("URL, добавленные по обращению правообладателя", false); // по обращению правообладателя
        ...
        BrowsersUtils4.openURL(browserPKG, "www.yt118.com", true);
        ...
        mDevice.findObject(By.text("URL-фильтр")).click();
        mDevice.waitForWindowUpdate(drWebPkg, 1000);
        BrowsersUtils4.setCategoryInCloudCheker("Нерекомендуемые сайты", true);

        Utils.startMainActivityFromHomeScreen(browserPKG);
        BrowsersUtils4.openURL(browserPKG, "http://justclick.ru", true);
        Thread.sleep(2000);
        ...
        mDevice.waitForWindowUpdate(drWebPkg, 1000);
        BrowsersUtils4.setCategoryInCloudCheker("Нерекомендуемые сайты", false);
        BrowsersUtils4.setCategoryInCloudCheker("Сайты для взрослых", true);

        Utils.startMainActivityFromHomeScreen(browserPKG);
        BrowsersUtils4.openURL(browserPKG, "http://xvideos.com", true);
        Thread.sleep(2000);
        ...
        mDevice.waitForWindowUpdate(drWebPkg, 1000);
        BrowsersUtils4.setCategoryInCloudCheker("Сайты для взрослых", false);
        BrowsersUtils4.setCategoryInCloudCheker("Насилие", true);

        Utils.startMainActivityFromHomeScreen(browserPKG);
        BrowsersUtils4.openURL(browserPKG, "http://twin-towers.net", true);
        Thread.sleep(2000);
        ...
        mDevice.waitForWindowUpdate(drWebPkg, 1000);
        BrowsersUtils4.setCategoryInCloudCheker("Насилие", false);
        BrowsersUtils4.setCategoryInCloudCheker("Оружие", true);

        Utils.startMainActivityFromHomeScreen(browserPKG);
        BrowsersUtils4.openURL(browserPKG, "http://guns.com", true);
        Thread.sleep(2000);
        ...
        mDevice.waitForWindowUpdate(drWebPkg, 1000);
        BrowsersUtils4.setCategoryInCloudCheker("Оружие", false);
        BrowsersUtils4.setCategoryInCloudCheker("Азартные игры", true);

        Utils.startMainActivityFromHomeScreen(browserPKG);
        BrowsersUtils4.openURL(browserPKG, "http://altaigames.com", true);
        Thread.sleep(2000);
        ...
        mDevice.waitForWindowUpdate(drWebPkg, 1000);
        BrowsersUtils4.setCategoryInCloudCheker("Азартные игры", false);
        BrowsersUtils4.setCategoryInCloudCheker("Наркотики", true);

        Utils.startMainActivityFromHomeScreen(browserPKG);
        BrowsersUtils4.openURL(browserPKG, "http://tweaker.org", true);
        Thread.sleep(2000);
        ...
        mDevice.waitForWindowUpdate(drWebPkg, 1000);
        BrowsersUtils4.setCategoryInCloudCheker("Наркотики", false);
        BrowsersUtils4.setCategoryInCloudCheker("Нецензурная лексика", true);

        Utils.startMainActivityFromHomeScreen(browserPKG);
        BrowsersUtils4.openURL(browserPKG, "http://udaff.com", true);
        Thread.sleep(2000);
        ...
        mDevice.waitForWindowUpdate(drWebPkg, 1000);
        BrowsersUtils4.setCategoryInCloudCheker("Нецензурная лексика", false);
        BrowsersUtils4.setCategoryInCloudCheker("Чаты", true);

        Utils.startMainActivityFromHomeScreen(browserPKG);
        BrowsersUtils4.openURL(browserPKG, "http://chat.ru", true);
        Thread.sleep(2000);
        ...
        mDevice.waitForWindowUpdate(drWebPkg, 1000);
        BrowsersUtils4.setCategoryInCloudCheker("Чаты", false);
        BrowsersUtils4.setCategoryInCloudCheker("Терроризм", true);

        Utils.startMainActivityFromHomeScreen(browserPKG);
        BrowsersUtils4.openURL(browserPKG, "http://www.deadhouse.ru/gallery/terrorism/", true);
        Thread.sleep(2000);
        ...
        mDevice.waitForWindowUpdate(drWebPkg, 1000);
        BrowsersUtils4.setCategoryInCloudCheker("Терроризм", false);
        BrowsersUtils4.setCategoryInCloudCheker("Электронная почта", true);

        Utils.startMainActivityFromHomeScreen(browserPKG);
        BrowsersUtils4.openURL(browserPKG, "http://e-mail.ru", true);
        Thread.sleep(2000);
        ...
        mDevice.waitForWindowUpdate(drWebPkg, 1000);
        BrowsersUtils4.setCategoryInCloudCheker("Электронная почта", false);
        BrowsersUtils4.setCategoryInCloudCheker("Социальные сети", true);

        Utils.startMainActivityFromHomeScreen(browserPKG);
        BrowsersUtils4.openURL(browserPKG, "http://vk.com", true);
        Thread.sleep(2000);
        ...
        mDevice.waitForWindowUpdate(drWebPkg, 1000);
        BrowsersUtils4.setCategoryInCloudCheker("Социальные сети", false);
        BrowsersUtils4.setCategoryInCloudCheker("URL, добавленные по обращению правообладателя", true);

        Utils.startMainActivityFromHomeScreen(browserPKG);
        BrowsersUtils4.openURL(browserPKG, "http://drweb-ru.com", true);
        Thread.sleep(2000);
